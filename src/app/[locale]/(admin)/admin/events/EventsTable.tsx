        ...
        <tbody>
          {events.map((event) => (
            <tr key={event.id} className="border-b last:border-0 hover:bg-gray-50 transition-colors">
              ...
              <td className="px-4 py-3 text-gray-500">{event.capacity ?? tc("unlimited")}</td>
              ...
              <td className="px-4 py-3">
                ...
                >
                  {event.published ? tc("published") : tc("draft")}
                </span>
              </td>
              <td className="px-4 py-3">
                <div className="flex items-center gap-2">
                  ...
                  >
                    {event.published ? tc("unpublish") : tc("publish")}
                  </button>
                  <button
