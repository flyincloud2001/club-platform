...
function HeroClient({ heroImageUrl, locale }: { heroImageUrl: string | null; locale: string }) {
  ...
  return (
    <section
      className="relative flex items-center min-h-screen px-4 sm:px-12 lg:px-20 py-20 overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-7 max-w-4xl w-full">
        ...
        <FadeIn delay={0.18}>
          <p
            className="text-xl sm:text-2xl font-light leading-snug pl-6"
        ...
        <FadeIn delay={0.32}>
          <p
            className="text-base leading-relaxed max-w-lg pl-6"
        ...
        <FadeIn direction="up" delay={0.5}>
          <div className="flex flex-row items-center gap-4 mt-1 pl-6 flex-wrap">
            <a
              href="#about"
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-8 rounded-2xl overflow-hidden" style={{ backgroundColor: PRIMARY }}>
