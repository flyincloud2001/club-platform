...
export type EmailTemplateOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "subject" | "body" | "updatedAt", ExtArgs["result"]["emailTemplate"]>
...
export interface EmailTemplateDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const emailTemplateWithKeyOnly = await prisma.emailTemplate.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many EmailTemplates and only return the `key`
   * const emailTemplateWithKeyOnly = await prisma.emailTemplate.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more EmailTemplates and only return the `key`
   * const emailTemplateWithKeyOnly = await prisma.emailTemplate.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
